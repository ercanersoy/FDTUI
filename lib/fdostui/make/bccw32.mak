# bccw32.mak
#
# makefile for Borland C/C++ 32-bit Windows
#
...
# Requries Borland compiler tools.
# Change into this directory and type 'make -f bccw32.mak'
# 
# ..\obj\bccw32 directory will be populated with object files
# ..\lib\fdtuibcc.lib is the library that will be created
# 
...
CFLAGS= -I$(I) -c -D__NT__ 
CXXFLAGS= -I$(I) -c -D__NT__ 
...
clean:
    ...
    @if exist $(L)\fdtuibcc.lib del $(L)\fdtuibcc.lib
