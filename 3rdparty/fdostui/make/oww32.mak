# oww32.mak
#
# makefile for OpenWatcom 32-bit Windows
#
...
# Change into this directory and type 'wmake -f oww32.mak'
# 
# ..\obj\oww32 directory will be populated with object files
# ..\lib\fdtuiw32.lib is the library that will be created
# 
...
AFLAGS= -3r -mf -bt=NT -d1 -i=$(I)
CFLAGS= -3r -mf -bt=NT -d3 -i=$(I)
CXXFLAGS= -3r -mf -bt=NT -d3 -i=$(I)
...
clean: .SYMBOLIC
    ...
    @if exist $(L)\fdtuiw32.lib del $(L)\fdtuiw32.lib
