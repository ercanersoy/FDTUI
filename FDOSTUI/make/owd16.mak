# owd16.mak
#
# makefile for OpenWatcom 16-bit FreeDOS
#
...
# from: United States.
#
# Build 16-bit FDOSTUI library
# FreeDOS or Windows Host Operating System
# Requries OpenWatcom compiler tools
# Change into this directory and type 'wmake -f owd16.mak'
# 
# ..\obj\owd16 directory will be populated with object files
# ..\lib\fdtuid16.lib is the library that will be created
# 
...
AFLAGS= -mm -0 -bt=DOS -d1 -i=$(I)
CFLAGS= -mm -0 -bt=DOS -d3 -i=$(I)
CXXFLAGS= -mm -0 -bt=DOS -d3 -i=$(I)
...
$(L)\fdtuid16.lib: $(TUIOBJ)
	wlib $@ @owd16.lbc

$(O)\hw.obj : $(S16)\hw.asm 
	$(AS) $(AFLAGS) -fo=$@ $(S16)\hw.asm
    
$(O)\mouse.obj : $(S16)\mouse.asm $(I)\mouse.inc
	$(AS) $(AFLAGS) -fo=$@ $(S16)\mouse.asm
    
$(O)\screen.obj : $(S16)\screen.asm 
	$(AS) $(AFLAGS) -fo=$@ $(S16)\screen.asm
    
$(O)\video.obj : $(S16)\video.asm $(I)\video.inc
	$(AS) $(AFLAGS) -fo=$@ $(S16)\video.asm
...
clean: .SYMBOLIC
    ...
    @if exist $(L)\fdtuid16.lib del $(L)\fdtuid16.lib
